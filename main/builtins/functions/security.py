    ...
    def login_required_wrapper(func):
        ...
        def secure_function(*args, **kwargs):
            ...
            if on_error_endpoint == "":
                return redirect(url_for("errors.redirect_catch_all", message="on_error_endpoint not in args"))

            try:
                url_for(on_error_endpoint)
            except BuildError:
                return redirect(url_for("errors.redirect_catch_all", tried=on_error_endpoint))
    ...
    def logged_in_check_wrapper(func):
        ...
        def secure_function(*args, **kwargs):
            ...
            try:
                ...
                return redirect(url_for("errors.redirect_catch_all", tried=on_true_endpoint))
