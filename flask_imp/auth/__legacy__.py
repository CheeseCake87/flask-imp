...
def hash_password(password: str, salt: str, encrypt: int = 512, pepper_length: int = 1) -> str:
    """ Legacy method, use encrypt_password instead """
    return encrypt_password(password, salt, encrypt, pepper_length)


def sha_password(password: str, salt: str, encrypt: int = 512, pepper_length: int = 1) -> str:
    """ Legacy method, use encrypt_password instead """
...
class Auth:
    ...
    def encrypt_password(
        ...
        return encrypt_password(password, salt, encryption_level, pepper_length, pepper_position)
    ...
    def authenticate_password(
        ...
        return authenticate_password(
            input_password, database_password, database_salt, encryption_level, pepper_length, pepper_position
        )
    ...
    def auth_password(
        ...
        """ Legacy class method, use from flask_imp.auth import authenticate_password instead """
        return authenticate_password(input_password, database_password, database_salt, encrypt, pepper_length)
