...
def create_all_models():
    """
    Creates database based on the models from_file
    """
    db.create_all()

    return render_template(
        bp.tmpl("create-models.html")
    )


@bp.route("/database-example", methods=["GET"])
def database_example():
    # Load the ExampleUser class found in the import_models from_folder, this way saves having to import files
